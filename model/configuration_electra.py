...
def get_generator_config(config):
    ...
    gen_config.hidden_size = int(round(
      config.hidden_size * eval(config.generator_size)))
    # gen_config.embedding_size = int(round(
    #     config.embedding_size * config.generator_hidden_size))
    # gen_config.num_hidden_layers = int(round(
    #     config.num_hidden_layers * config.generator_layers))
